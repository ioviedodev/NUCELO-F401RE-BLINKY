...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(LED_TMR_GPIO_Port, LED_TMR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LED_TMR_Pin */
  GPIO_InitStruct.Pin = LED_TMR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_TMR_GPIO_Port, &GPIO_InitStruct);
